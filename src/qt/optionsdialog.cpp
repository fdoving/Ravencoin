...
void OptionsDialog::on_thirdPartyTxUrlsReset_clicked()
{
    ...
    ui->thirdPartyTxUrls->setText("https://api.ravencoin.org/tx/%s|https://rvn.cryptoscope.io/tx/?txid=%s|https://explorer.ravenland.org/tx/%s|https://blockbook.ravencoin.org/tx/%s|https://explorer.mangofarmassets.com/tx/%s");
}
